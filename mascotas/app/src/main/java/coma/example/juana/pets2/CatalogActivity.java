package coma.example.juana.pets2;
...
import coma.example.juana.pets2.data.PetContract.PetEntry;
import coma.example.juana.pets2.data.PetDbHelper;
...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        // Filter results WHERE "gender" = 'My gender'
        ...
        try {
            ...
            displayView.append(PetEntry._ID + "_" +
                    PetEntry.COLUMN_PET_NAME + "_" +
                    PetEntry.COLUMN_PET_BREED + "_" +
                    PetEntry.COLUMN_PET_GENDER +  "_" +
                    PetEntry.COLUMN_PET_WEIGHT +"\n" );
            ...
            int genderColumIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_GENDER);
            ...
            while(cursor.moveToNext()) {
                ...
                int currentWeight = cursor.getInt(weightColumIndex);

                displayView.append(("\n"+ currentID + "_" + currentName + "_" + currentBreed  + "_" + currentGender  + "_" + currentWeight));
            }
